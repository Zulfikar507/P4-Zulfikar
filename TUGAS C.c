...
int main(){
	printf("| SELAMAT DATANG DI PROGRAM KASIR KELOMPOK : 28 | \n\n");
   ...
   do {
    ...
    if(login != 1){
       ...
       printf("Mohon Maaf Akun Anda Kami Blockir Untuk Sementara\n");
	   printf("silahkan hubungi kami melalui e-mail kepodora@yahoo.com terima kasih\n");
    }
